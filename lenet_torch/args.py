...
def init_arguments():
    ...
    parser.add_argument('--save_trainer', action='store_true', default=False, help='Whether to save the trainer.')
    ...
    parser.add_argument('--print_result_per_epochs', type=int, default=10, help='How many epochs that the evaluated results be printed once?')
