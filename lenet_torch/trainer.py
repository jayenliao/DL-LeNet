...
class Trainer:
    def __init__(self, X_tr, y_tr, X_te, y_te, device, model_name:str, num_conv_layers:int, model_hyper_param:dict, optimizer:str, lr:float, epochs:int, batch_size:int, savePATH:str, save_model:bool, pretrained_model:str, verbose:bool, random_state=4028):
        ...
        self.device = device
        self.dataset_tr = TensorDataset(X_tr, y_tr)
