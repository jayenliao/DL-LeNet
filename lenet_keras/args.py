...
def init_arguments():
    ...
    parser.add_argument('--strides', nargs='+', type=int, default=(1, 1), help='stridess for conv. layers.')
    parser.add_argument('--pooling_size', type=int, default=2, help='Size of max pooling layer')
    #parser.add_argument('--pooling_strides', type=int, default=1, help='No. of strides of max pooling layer')
    parser.add_argument('--hidden_sizes', nargs='+', type=int, default=[256, 128], help='Dimension of the hidden state of the linear layers')
    ...
    parser.add_argument('--eval_metrics', type=str, default='accuracy')
    parser.add_argument('--loss_fun', type=str, default='sparse_categorical_crossentropy')
